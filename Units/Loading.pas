...
type
  TLoading = class
    ...
    public
          ...
          class procedure ShowLoad(const Frm : Tform; const msg: string);
  end;
...
//        Fundo.Fill.Color := TAlphaColorRec.Black;
        Fundo.Fill.Kind := TBrushKind.none;
...
class procedure TLoading.ShowLoad(const Frm: Tform; const msg: string);
var
        FService: IFMXVirtualKeyboardService;
begin
        // Panel de fundo opaco...
